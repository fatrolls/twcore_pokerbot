 ...
 */
public class VectoidReUse<K, V> implements Map<K, V> {
    ...
    public V put(K key, V value) {
        ...
        if (index != -1)
            ...
            //Try to fill in any null placeholders first.
            index = indexOfKey(null);
            if (index == -1) {
                keys.add(key);
                values.add(value);
            } else {
    ...
    public V remove(Object o) {
        ...
        //Set both  key, value to null, so position is kept.
        keys.set(index, null);
