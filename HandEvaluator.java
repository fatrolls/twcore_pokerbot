...
public class HandEvaluator {
    ...
    public static final int NO_OF_RANKINGS  = 6;
    ...
    public static final int[] RANKING_FACTORS = {371293, 28561, 2197, 169, 13, 1};
    ...
    private void calculateHighCard() {
        ...
        for (Card card : cards) {
            ...
            if (index > 5) // We don't need any more kickers.
                break;
        }
    }
    ...
    private boolean isOnePair() {
        if (noOfPairs == 1) {
            ...
            for (Card card : cards) {
                ...
                if (rank != pairRank) {
                    rankings[index++] = rank;
                    if (index > 4) // We don't need any more kickers.
                        break;
                }
            }
            return true;
    ...
    private boolean isThreeOfAKind() {
        if (tripleRank != -1) {
            ...
            for (Card card : cards) {
                ...
                if (rank != tripleRank) {
                    rankings[index++] = rank;
                    if (index > 3) // We don't need any more kickers.
                        break;
                }
            }
            return true;
            ...
            for (Card card : cards) {
                if (card.getSuit() == flushSuit) {
                    ...
                    if (index == 1)
                        flushRank = rank;
                    rankings[index++] = rank;
                    if (index > 5) // We don't need more kickers.
                        break;
                }
            }
            return true;
