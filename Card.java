...
public class Card implements Comparable<Card> {
    ...
    /** The position of the blank card after last card **/
    ...
    /** The rank symbols. */
    public static final char[] RANK_SYMBOLS = {
    ...
    public int getLvzPosition() {
        //This is the way I organized the cards in the lvz file.
    ...
    @Override
    public int hashCode() {
	//Don't mess with this or the HandEvaluator will break!.
    ...
    public String toString() {
        return new String(new char[] { RANK_SYMBOLS[rank], SUIT_SYMBOLS[suit] });
    }
